...
template <> constexpr inline auto RacingGame::qt_create_metaobjectdata<qt_meta_tag_ZN10RacingGameE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<RacingGame, qt_meta_tag_ZN10RacingGameE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject RacingGame::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10RacingGameE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10RacingGameE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10RacingGameE_t>.metaTypes,
    nullptr
} };
...
void *RacingGame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10RacingGameE_t>.strings))
